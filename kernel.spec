...
Source0: https://cdn.confidential.cloud/constellation/kernel/6.2.0-100.constellation/linux-6.2.0-1018-azure.tar.gz
...
Patch3: ubuntu-header-check.patch
%endif
...
ApplyOptionalPatch ubuntu-header-check.patch
